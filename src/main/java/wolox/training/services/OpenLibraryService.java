...
public class OpenLibraryService {
	...
	private String openlibraryResourceUrl;

	public Optional<Book> bookInfo(String isbn) {
		RestTemplate restTemplate = new RestTemplate();		
		if ( openlibraryResourceUrl == null || openlibraryResourceUrl.isEmpty()) {
			openlibraryResourceUrl = "https://openlibrary.org/api/books?bibkeys=ISBN:{isbn}&format=json&jscmd=data";
		}
